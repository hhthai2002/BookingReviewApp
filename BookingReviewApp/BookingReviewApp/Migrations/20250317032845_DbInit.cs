    ...
    public partial class DbInit : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookingPosts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BookingPosts_Users_BookerId",
                        column: x => x.BookerId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    BookingPostId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reports_BookingPosts_BookingPostId",
                        column: x => x.BookingPostId,
                        principalTable: "BookingPosts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reviews_BookingPosts_BookingPostId",
                        column: x => x.BookingPostId,
                        principalTable: "BookingPosts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reports_BookingPostId",
                table: "Reports",
                column: "BookingPostId");

            migrationBuilder.CreateIndex(
                name: "IX_Reviews_BookingPostId",
                table: "Reviews",
                column: "BookingPostId");
